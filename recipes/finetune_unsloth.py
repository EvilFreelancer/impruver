...
import wandb
import torch
from transformers import Trainer, logging, BitsAndBytesConfig, DataCollatorForTokenClassification
...
try:
    ...
    print(
        "`unsloth` package is not installed. Please run the following command: "
        "`wget -qO- https://raw.githubusercontent.com/unslothai/unsloth/main/unsloth/_auto_install.py | python -` "
        "to obtain command which would help you to install a correct version."
    )
    exit()
